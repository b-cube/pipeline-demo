...
# from yaml_configs import import_yaml_configs
...
class OgcReader():
    ...
    def _get_config(self):
        # data = import_yaml_configs(['../configs/ogc_parameters.yaml'])
        # this is asinine and i am not amused. 
        data = [{'common': [{'format': None, 'name': 'service', 'type': 'string'},
   {'format': None, 'name': 'request', 'type': 'string'},
   {'format': None, 'name': 'version', 'type': 'string'}],
  'methods': [{'name': 'GETCAPABILITIES',
    'params': [{'format': None, 'name': None, 'type': None}]},
   {'name': 'GETMAP',
    'params': [{'format': None, 'name': 'format', 'type': 'string'},
     {'format': 'comma-delimited string', 'name': 'layers', 'type': 'string'},
     {'format': 'minx,miny,maxx,maxy', 'name': 'bbox', 'type': 'string'},
     {'format': None, 'name': 'height', 'type': 'int'},
     {'format': None, 'name': 'width', 'type': 'int'},
     {'format': None, 'name': 'styles', 'type': 'string'},
     {'format': None, 'name': 'srs', 'type': 'string'},
     {'format': None, 'name': 'transparent', 'type': 'string'},
     {'format': None, 'name': 'bgcolor', 'type': 'hexadecimal'},
     {'format': None, 'name': 'elevation', 'type': 'string'},
     {'format': None, 'name': 'time', 'type': 'string'}]},
   {'name': 'GETFEATUREINFO',
    'params': [{'format': None, 'name': 'info_format', 'type': 'string'},
     {'format': None, 'name': 'feature_count', 'type': 'int'}]}],
  'name': 'WMS111'},
 {'common': [{'format': None, 'name': 'service', 'type': 'string'},
   {'format': None, 'name': 'request', 'type': 'string'},
   {'format': None, 'name': 'version', 'type': 'string'}],
  'methods': [{'name': 'GETCAPABILITIES',
    'params': [{'format': None, 'name': None, 'type': None}]},
   ...
   {'name': 'GETFEATUREINFO',
    'params': [{'format': None, 'name': 'info_format', 'type': 'string'},
     {'format': None, 'name': 'feature_count', 'type': 'int'}]}],
  'name': 'WMS130'}]
        # print '*******', self.service.upper(), self.version
